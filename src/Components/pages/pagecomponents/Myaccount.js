...
function Myaccount() {
  ...
  return (
    <div className="your__accout">
      <h2 className="account__heading">Hello {user.displayName}</h2>
      <br />
      <br />
      <h3 className="accout__details">Email:- {user.email}</h3>

      <h3 className="accout__details">Id:- {user.uid}</h3>
      <div className="logout__buttn" onClick={handelLogout}>
        <span>
          <svg
            width={20}
            height={20}
